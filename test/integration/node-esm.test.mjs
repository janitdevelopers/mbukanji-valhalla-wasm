 ...
 * 
 * Tests path resolution and initialization in Node.js ESM environment.
 * 
 * Run with: node test/integration/node-esm.test.mjs
 */

import { createRouter, getWasmPaths } from '../../dist/index.js'

async function testNodeESM() {
  console.log('🧪 Testing Node.js ESM environment...\n')
