...
function getBaseUrl() {
  try {
    if (typeof ({ url: (typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('out.js', document.baseURI).href)) }) !== "undefined" && (typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('out.js', document.baseURI).href))) {
      ...
      return new URL(".", (typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('out.js', document.baseURI).href))).href;
    }
  } catch {
  }
...
exports.DEFAULT_WASM_PATHS = DEFAULT_WASM_PATHS;
exports.VERSION = VERSION;
exports.ValhallaError = ValhallaError;
exports.ValhallaErrorCode = ValhallaErrorCode;
exports.ValhallaRouter = ValhallaRouter;
...
exports.getWasmPaths = getWasmPaths;
exports.haversineDistance = haversineDistance;
exports.isBundlerEnvironment = isBundlerEnvironment;
exports.isValhallaError = isValhallaError;
exports.isWithinBounds = isWithinBounds;
exports.isWorkerEnvironment = isWorkerEnvironment;
exports.midpoint = midpoint;
exports.polylineBounds = polylineBounds;
exports.polylineToGeoJSON = polylineToGeoJSON;
exports.simplifyPolyline = simplifyPolyline;
exports.validateWasmPaths = validateWasmPaths;
